...
<form action="./index.php?page=Ctrl_modules&action=add" method="post" class="form">
    ...
    <div class="row">
        <div class="col">
            <label for="code">Code :</label><input type="text" name="code" id="code" class="form-control" required><br>
        </div>
        <div class="col">
            <label for="heure">Heure :</label><input type="time" name="heure" id="heure" class="form-control" required><br>
        </div>
    </div>
